<template>
  <div id="app">
    ...
    <main>
      ...
      <!-- <products-view :addToCart="addToCart" :cartCount="cartCount" :canAddToCart="canAddToCart"
        :cartItemCount="cartItemCount" :products="products" :searchResults="searchResults"></products-view>
